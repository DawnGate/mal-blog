...
![Demo-Ci](/assets/images/blogs/micro-be-ecommerce-ci.png)
_pic: Demo ci _
![Demo-Ci-Settings-enviroment](/assets/images/blogs/micro-be-ecommerce-ci-settings.png)
_pic: Demo ci settings _

![Demo-Postmand-Docker](/assets/images/blogs/micro-be-ecommerce-done.png)
